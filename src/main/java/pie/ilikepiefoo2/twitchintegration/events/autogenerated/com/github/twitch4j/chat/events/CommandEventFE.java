...
public class CommandEventFE extends net.minecraftforge.eventbus.api.Event {
    private final com.github.twitch4j.chat.events.CommandEvent event;

    public CommandEventFE( com.github.twitch4j.chat.events.CommandEvent event )
    {
        this.event = event;
    }

    public boolean equals( java.lang.Object arg0 ) // Declaring Class: com.github.twitch4j.chat.events.CommandEvent
    {
        return this.event.equals( arg0 );

    }
    public java.lang.String toString( ) // Declaring Class: com.github.twitch4j.chat.events.CommandEvent
    {
        return this.event.toString(  );

    }
    public int hashCode( ) // Declaring Class: com.github.twitch4j.chat.events.CommandEvent
    {
        return this.event.hashCode(  );

    }
    public java.util.Set getPermissions( ) // Declaring Class: com.github.twitch4j.chat.events.CommandEvent
    {
        return this.event.getPermissions(  );

    }
    public com.github.twitch4j.chat.enums.CommandSource getSource( ) // Declaring Class: com.github.twitch4j.chat.events.CommandEvent
    {
        return this.event.getSource(  );

    }
    public java.lang.String getCommand( ) // Declaring Class: com.github.twitch4j.chat.events.CommandEvent
    {
        return this.event.getCommand(  );

    }
    public void respondToUser( java.lang.String arg0 ) // Declaring Class: com.github.twitch4j.chat.events.CommandEvent
    {
        this.event.respondToUser( arg0 );

    }
    public java.lang.String getCommandPrefix( ) // Declaring Class: com.github.twitch4j.chat.events.CommandEvent
    {
        return this.event.getCommandPrefix(  );

    }
    public java.lang.String getSourceId( ) // Declaring Class: com.github.twitch4j.chat.events.CommandEvent
    {
        return this.event.getSourceId(  );

    }
    public com.github.twitch4j.common.events.domain.EventUser getUser( ) // Declaring Class: com.github.twitch4j.chat.events.CommandEvent
    {
