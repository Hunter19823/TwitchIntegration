...
public class BitsBadgeEarnedEventFE extends net.minecraftforge.eventbus.api.Event {
    private final com.github.twitch4j.chat.events.channel.BitsBadgeEarnedEvent event;

    public BitsBadgeEarnedEventFE( com.github.twitch4j.chat.events.channel.BitsBadgeEarnedEvent event )
    {
        this.event = event;
    }

    public boolean equals( java.lang.Object arg0 ) // Declaring Class: com.github.twitch4j.chat.events.channel.BitsBadgeEarnedEvent
    {
        return this.event.equals( arg0 );

    }
    public java.lang.String toString( ) // Declaring Class: com.github.twitch4j.chat.events.channel.BitsBadgeEarnedEvent
    {
        return this.event.toString(  );

    }
    public int hashCode( ) // Declaring Class: com.github.twitch4j.chat.events.channel.BitsBadgeEarnedEvent
    {
        return this.event.hashCode(  );

    }
    public int getBitsThreshold( ) // Declaring Class: com.github.twitch4j.chat.events.channel.BitsBadgeEarnedEvent
    {
        return this.event.getBitsThreshold(  );

    }
    public com.github.twitch4j.common.events.domain.EventUser getUser( ) // Declaring Class: com.github.twitch4j.chat.events.channel.BitsBadgeEarnedEvent
    {
