...
public class RitualEventFE extends net.minecraftforge.eventbus.api.Event {
    private final com.github.twitch4j.chat.events.channel.RitualEvent event;

    public RitualEventFE( com.github.twitch4j.chat.events.channel.RitualEvent event )
    {
        this.event = event;
    }

    public boolean equals( java.lang.Object arg0 ) // Declaring Class: com.github.twitch4j.chat.events.channel.RitualEvent
    {
        return this.event.equals( arg0 );

    }
    public java.lang.String toString( ) // Declaring Class: com.github.twitch4j.chat.events.channel.RitualEvent
    {
        return this.event.toString(  );

    }
    public int hashCode( ) // Declaring Class: com.github.twitch4j.chat.events.channel.RitualEvent
    {
        return this.event.hashCode(  );

    }
    public java.lang.String getRitualName( ) // Declaring Class: com.github.twitch4j.chat.events.channel.RitualEvent
    {
        return this.event.getRitualName(  );

    }
    public boolean isNewChatter( ) // Declaring Class: com.github.twitch4j.chat.events.channel.RitualEvent
    {
        return this.event.isNewChatter(  );

    }
    public com.github.twitch4j.common.events.domain.EventUser getUser( ) // Declaring Class: com.github.twitch4j.chat.events.channel.RitualEvent
    {
