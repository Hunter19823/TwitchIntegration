...
public class SlowModeEventFE extends net.minecraftforge.eventbus.api.Event {
    private final com.github.twitch4j.chat.events.roomstate.SlowModeEvent event;

    public SlowModeEventFE( com.github.twitch4j.chat.events.roomstate.SlowModeEvent event )
    {
        this.event = event;
    }

    public boolean equals( java.lang.Object arg0 ) // Declaring Class: com.github.twitch4j.chat.events.roomstate.SlowModeEvent
    {
        return this.event.equals( arg0 );

    }
    public java.lang.String toString( ) // Declaring Class: com.github.twitch4j.chat.events.roomstate.SlowModeEvent
    {
        return this.event.toString(  );

    }
    public int hashCode( ) // Declaring Class: com.github.twitch4j.chat.events.roomstate.SlowModeEvent
    {
        return this.event.hashCode(  );

    }
    public long getTime( ) // Declaring Class: com.github.twitch4j.chat.events.roomstate.SlowModeEvent
    {
