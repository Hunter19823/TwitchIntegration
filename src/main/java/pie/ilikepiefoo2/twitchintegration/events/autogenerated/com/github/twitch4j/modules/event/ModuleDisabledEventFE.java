package pie.ilikepiefoo2.twitchintegration.events.autogenerated.com.github.twitch4j.modules.event;


public class ModuleDisabledEventFE extends net.minecraftforge.eventbus.api.Event {
    private final com.github.twitch4j.modules.event.ModuleDisabledEvent event;

    public ModuleDisabledEventFE( com.github.twitch4j.modules.event.ModuleDisabledEvent event )
    {
        this.event = event;
    }

    public java.lang.String toString( ) // Declaring Class: com.github.philippheuer.events4j.core.domain.Event
    {
