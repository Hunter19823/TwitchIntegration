...
public class HypeTrainEndEventFE extends net.minecraftforge.eventbus.api.Event {
    private final com.github.twitch4j.pubsub.events.HypeTrainEndEvent event;

    public HypeTrainEndEventFE( com.github.twitch4j.pubsub.events.HypeTrainEndEvent event )
    {
        this.event = event;
    }

    public boolean equals( java.lang.Object arg0 ) // Declaring Class: com.github.twitch4j.pubsub.events.HypeTrainEndEvent
    {
        return this.event.equals( arg0 );

    }
    public java.lang.String toString( ) // Declaring Class: com.github.twitch4j.pubsub.events.HypeTrainEndEvent
    {
        return this.event.toString(  );

    }
    public int hashCode( ) // Declaring Class: com.github.twitch4j.pubsub.events.HypeTrainEndEvent
    {
        return this.event.hashCode(  );

    }
    public com.github.twitch4j.pubsub.domain.HypeTrainEnd getData( ) // Declaring Class: com.github.twitch4j.pubsub.events.HypeTrainEndEvent
    {
        return this.event.getData(  );

    }
    public java.lang.String getChannelId( ) // Declaring Class: com.github.twitch4j.pubsub.events.HypeTrainEndEvent
    {
