...
public class CharityCampaignDonationEventFE extends net.minecraftforge.eventbus.api.Event {
    public final com.github.twitch4j.pubsub.events.CharityCampaignDonationEvent event;

    public CharityCampaignDonationEventFE( com.github.twitch4j.pubsub.events.CharityCampaignDonationEvent event )
    {
        this.event = event;
    }

    public boolean equals( java.lang.Object arg0 ) // Declaring Class: com.github.twitch4j.pubsub.events.CharityCampaignDonationEvent
    {
        return this.event.equals( arg0 );
    }
    public java.lang.String getChannelId( ) // Declaring Class: com.github.twitch4j.pubsub.events.CharityCampaignDonationEvent
    {
        return this.event.getChannelId(  );
    }
    public com.github.twitch4j.pubsub.domain.CharityDonationData getData( ) // Declaring Class: com.github.twitch4j.pubsub.events.CharityCampaignDonationEvent
    {
    ...
    public int hashCode( ) // Declaring Class: com.github.twitch4j.pubsub.events.CharityCampaignDonationEvent
    {
    ...
    public java.lang.String toString( ) // Declaring Class: com.github.twitch4j.pubsub.events.CharityCampaignDonationEvent
    {
