...
public class UserPredictionMadeEventFE extends net.minecraftforge.eventbus.api.Event {
    private final com.github.twitch4j.pubsub.events.UserPredictionMadeEvent event;

    public UserPredictionMadeEventFE( com.github.twitch4j.pubsub.events.UserPredictionMadeEvent event )
    {
        this.event = event;
    }

    public boolean equals( java.lang.Object arg0 ) // Declaring Class: com.github.twitch4j.pubsub.events.UserPredictionMadeEvent
    {
        return this.event.equals( arg0 );

    }
    public java.lang.String toString( ) // Declaring Class: com.github.twitch4j.pubsub.events.UserPredictionMadeEvent
    {
        return this.event.toString(  );

    }
    public int hashCode( ) // Declaring Class: com.github.twitch4j.pubsub.events.UserPredictionMadeEvent
    {
        return this.event.hashCode(  );

    }
    public java.time.Instant getTimestamp( ) // Declaring Class: com.github.twitch4j.pubsub.events.UserPredictionMadeEvent
    {
        return this.event.getTimestamp(  );

    }
    public com.github.twitch4j.pubsub.domain.Prediction getPrediction( ) // Declaring Class: com.github.twitch4j.pubsub.events.UserPredictionMadeEvent
    {
