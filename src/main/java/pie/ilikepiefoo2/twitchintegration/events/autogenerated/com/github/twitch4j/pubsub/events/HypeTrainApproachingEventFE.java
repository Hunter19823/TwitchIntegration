...
public class HypeTrainApproachingEventFE extends net.minecraftforge.eventbus.api.Event {
    public final com.github.twitch4j.pubsub.events.HypeTrainApproachingEvent event;

    public HypeTrainApproachingEventFE( com.github.twitch4j.pubsub.events.HypeTrainApproachingEvent event )
    {
        this.event = event;
    }

    public boolean equals( java.lang.Object arg0 ) // Declaring Class: com.github.twitch4j.pubsub.events.HypeTrainApproachingEvent
    {
        return this.event.equals( arg0 );
    }
    public java.lang.String toString( ) // Declaring Class: com.github.twitch4j.pubsub.events.HypeTrainApproachingEvent
    {
        return this.event.toString(  );
    }
    public int hashCode( ) // Declaring Class: com.github.twitch4j.pubsub.events.HypeTrainApproachingEvent
    {
        return this.event.hashCode(  );
    }
    public com.github.twitch4j.pubsub.domain.HypeTrainApproaching getData( ) // Declaring Class: com.github.twitch4j.pubsub.events.HypeTrainApproachingEvent
    {
