...
public class ChannelUnbanRequestCreateEventFE extends net.minecraftforge.eventbus.api.Event {
    private final com.github.twitch4j.pubsub.events.ChannelUnbanRequestCreateEvent event;

    public ChannelUnbanRequestCreateEventFE( com.github.twitch4j.pubsub.events.ChannelUnbanRequestCreateEvent event )
    {
        this.event = event;
    }

    public boolean equals( java.lang.Object arg0 ) // Declaring Class: com.github.twitch4j.pubsub.events.ChannelUnbanRequestCreateEvent
    {
        return this.event.equals( arg0 );

    }
    public java.lang.String toString( ) // Declaring Class: com.github.twitch4j.pubsub.events.ChannelUnbanRequestCreateEvent
    {
        return this.event.toString(  );

    }
    public int hashCode( ) // Declaring Class: com.github.twitch4j.pubsub.events.ChannelUnbanRequestCreateEvent
    {
        return this.event.hashCode(  );

    }
    public com.github.twitch4j.pubsub.domain.CreatedUnbanRequest getUnbanRequest( ) // Declaring Class: com.github.twitch4j.pubsub.events.ChannelUnbanRequestCreateEvent
    {
