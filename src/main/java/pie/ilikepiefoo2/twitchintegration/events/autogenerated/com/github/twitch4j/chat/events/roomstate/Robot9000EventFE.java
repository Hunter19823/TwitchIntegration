...
public class Robot9000EventFE extends net.minecraftforge.eventbus.api.Event {
    private final com.github.twitch4j.chat.events.roomstate.Robot9000Event event;

    public Robot9000EventFE( com.github.twitch4j.chat.events.roomstate.Robot9000Event event )
    {
        this.event = event;
    }

    public boolean equals( java.lang.Object arg0 ) // Declaring Class: com.github.twitch4j.chat.events.roomstate.Robot9000Event
    {
        return this.event.equals( arg0 );

    }
    public java.lang.String toString( ) // Declaring Class: com.github.twitch4j.chat.events.roomstate.Robot9000Event
    {
        return this.event.toString(  );

    }
    public int hashCode( ) // Declaring Class: com.github.twitch4j.chat.events.roomstate.Robot9000Event
    {
