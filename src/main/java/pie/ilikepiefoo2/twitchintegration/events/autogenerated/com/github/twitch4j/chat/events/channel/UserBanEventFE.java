...
public class UserBanEventFE extends net.minecraftforge.eventbus.api.Event {
    private final com.github.twitch4j.chat.events.channel.UserBanEvent event;

    public UserBanEventFE( com.github.twitch4j.chat.events.channel.UserBanEvent event )
    {
        this.event = event;
    }

    public boolean equals( java.lang.Object arg0 ) // Declaring Class: com.github.twitch4j.chat.events.channel.UserBanEvent
    {
        return this.event.equals( arg0 );

    }
    public java.lang.String toString( ) // Declaring Class: com.github.twitch4j.chat.events.channel.UserBanEvent
    {
        return this.event.toString(  );

    }
    public int hashCode( ) // Declaring Class: com.github.twitch4j.chat.events.channel.UserBanEvent
    {
        return this.event.hashCode(  );

    }
    public java.lang.String getReason( ) // Declaring Class: com.github.twitch4j.chat.events.channel.UserBanEvent
    {
        return this.event.getReason(  );

    }
    public com.github.twitch4j.common.events.domain.EventUser getUser( ) // Declaring Class: com.github.twitch4j.chat.events.channel.UserBanEvent
    {
