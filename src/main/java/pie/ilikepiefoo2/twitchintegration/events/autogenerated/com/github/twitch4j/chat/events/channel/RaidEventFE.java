...
public class RaidEventFE extends net.minecraftforge.eventbus.api.Event {
    private final com.github.twitch4j.chat.events.channel.RaidEvent event;

    public RaidEventFE( com.github.twitch4j.chat.events.channel.RaidEvent event )
    {
        this.event = event;
    }

    public boolean equals( java.lang.Object arg0 ) // Declaring Class: com.github.twitch4j.chat.events.channel.RaidEvent
    {
        return this.event.equals( arg0 );

    }
    public java.lang.String toString( ) // Declaring Class: com.github.twitch4j.chat.events.channel.RaidEvent
    {
        return this.event.toString(  );

    }
    public int hashCode( ) // Declaring Class: com.github.twitch4j.chat.events.channel.RaidEvent
    {
        return this.event.hashCode(  );

    }
    public java.lang.Integer getViewers( ) // Declaring Class: com.github.twitch4j.chat.events.channel.RaidEvent
    {
        return this.event.getViewers(  );

    }
    public com.github.twitch4j.common.events.domain.EventUser getRaider( ) // Declaring Class: com.github.twitch4j.chat.events.channel.RaidEvent
    {
