...
public class ChannelChangeGameEventFE extends net.minecraftforge.eventbus.api.Event {
    private final com.github.twitch4j.common.events.channel.ChannelChangeGameEvent event;

    public ChannelChangeGameEventFE( com.github.twitch4j.common.events.channel.ChannelChangeGameEvent event )
    {
        this.event = event;
    }

    public boolean equals( java.lang.Object arg0 ) // Declaring Class: com.github.twitch4j.common.events.channel.ChannelChangeGameEvent
    {
        return this.event.equals( arg0 );

    }
    public java.lang.String toString( ) // Declaring Class: com.github.twitch4j.common.events.channel.ChannelChangeGameEvent
    {
        return this.event.toString(  );

    }
    public int hashCode( ) // Declaring Class: com.github.twitch4j.common.events.channel.ChannelChangeGameEvent
    {
        return this.event.hashCode(  );

    }
    public com.github.twitch4j.common.events.domain.EventChannel getChannel( ) // Declaring Class: com.github.twitch4j.common.events.channel.ChannelChangeGameEvent
    {
        return this.event.getChannel(  );

    }
    public java.lang.String getGameId( ) // Declaring Class: com.github.twitch4j.common.events.channel.ChannelChangeGameEvent
    {
