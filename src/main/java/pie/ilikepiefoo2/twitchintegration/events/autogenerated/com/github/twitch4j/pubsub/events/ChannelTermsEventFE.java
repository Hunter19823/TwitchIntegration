...
public class ChannelTermsEventFE extends net.minecraftforge.eventbus.api.Event {
    public final com.github.twitch4j.pubsub.events.ChannelTermsEvent event;

    public ChannelTermsEventFE( com.github.twitch4j.pubsub.events.ChannelTermsEvent event )
    {
        this.event = event;
    }

    public boolean equals( java.lang.Object arg0 ) // Declaring Class: com.github.twitch4j.pubsub.events.ChannelTermsEvent
    {
        return this.event.equals( arg0 );
    }
    public java.lang.String getChannelId( ) // Declaring Class: com.github.twitch4j.pubsub.events.ChannelTermsEvent
    {
        return this.event.getChannelId(  );
    }
    public com.github.twitch4j.pubsub.domain.ChannelTermsAction getData( ) // Declaring Class: com.github.twitch4j.pubsub.events.ChannelTermsEvent
    {
    ...
    public int hashCode( ) // Declaring Class: com.github.twitch4j.pubsub.events.ChannelTermsEvent
    {
    ...
    public java.lang.String toString( ) // Declaring Class: com.github.twitch4j.pubsub.events.ChannelTermsEvent
    {
