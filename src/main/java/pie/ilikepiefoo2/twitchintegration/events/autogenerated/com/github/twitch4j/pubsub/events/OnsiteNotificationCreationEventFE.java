...
public class OnsiteNotificationCreationEventFE extends net.minecraftforge.eventbus.api.Event {
    private final com.github.twitch4j.pubsub.events.OnsiteNotificationCreationEvent event;

    public OnsiteNotificationCreationEventFE( com.github.twitch4j.pubsub.events.OnsiteNotificationCreationEvent event )
    {
        this.event = event;
    }

    public boolean equals( java.lang.Object arg0 ) // Declaring Class: com.github.twitch4j.pubsub.events.OnsiteNotificationCreationEvent
    {
        return this.event.equals( arg0 );

    }
    public java.lang.String toString( ) // Declaring Class: com.github.twitch4j.pubsub.events.OnsiteNotificationCreationEvent
    {
        return this.event.toString(  );

    }
    public int hashCode( ) // Declaring Class: com.github.twitch4j.pubsub.events.OnsiteNotificationCreationEvent
    {
        return this.event.hashCode(  );

    }
    public com.github.twitch4j.pubsub.domain.CreateNotificationData getData( ) // Declaring Class: com.github.twitch4j.pubsub.events.OnsiteNotificationCreationEvent
    {
