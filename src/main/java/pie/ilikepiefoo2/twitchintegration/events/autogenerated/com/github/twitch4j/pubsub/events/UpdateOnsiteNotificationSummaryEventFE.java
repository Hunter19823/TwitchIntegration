...
public class UpdateOnsiteNotificationSummaryEventFE extends net.minecraftforge.eventbus.api.Event {
    private final com.github.twitch4j.pubsub.events.UpdateOnsiteNotificationSummaryEvent event;

    public UpdateOnsiteNotificationSummaryEventFE( com.github.twitch4j.pubsub.events.UpdateOnsiteNotificationSummaryEvent event )
    {
        this.event = event;
    }

    public boolean equals( java.lang.Object arg0 ) // Declaring Class: com.github.twitch4j.pubsub.events.UpdateOnsiteNotificationSummaryEvent
    {
        return this.event.equals( arg0 );

    }
    public java.lang.String toString( ) // Declaring Class: com.github.twitch4j.pubsub.events.UpdateOnsiteNotificationSummaryEvent
    {
        return this.event.toString(  );

    }
    public int hashCode( ) // Declaring Class: com.github.twitch4j.pubsub.events.UpdateOnsiteNotificationSummaryEvent
    {
        return this.event.hashCode(  );

    }
    public com.github.twitch4j.pubsub.domain.UpdateSummaryData getData( ) // Declaring Class: com.github.twitch4j.pubsub.events.UpdateOnsiteNotificationSummaryEvent
    {
        return this.event.getData(  );

    }
    public java.lang.String getUserId( ) // Declaring Class: com.github.twitch4j.pubsub.events.UpdateOnsiteNotificationSummaryEvent
    {
