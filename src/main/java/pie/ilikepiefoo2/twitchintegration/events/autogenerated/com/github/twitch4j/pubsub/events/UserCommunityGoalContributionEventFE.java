...
public class UserCommunityGoalContributionEventFE extends net.minecraftforge.eventbus.api.Event {
    public final com.github.twitch4j.pubsub.events.UserCommunityGoalContributionEvent event;

    public UserCommunityGoalContributionEventFE( com.github.twitch4j.pubsub.events.UserCommunityGoalContributionEvent event )
    {
        this.event = event;
    }

    public boolean equals( java.lang.Object arg0 ) // Declaring Class: com.github.twitch4j.pubsub.events.UserCommunityGoalContributionEvent
    {
    ...
    public java.lang.String getUserId( ) // Declaring Class: com.github.twitch4j.pubsub.events.UserCommunityGoalContributionEvent
    {
