...
public class ExtendSubscriptionEventFE extends net.minecraftforge.eventbus.api.Event {
    private final com.github.twitch4j.chat.events.channel.ExtendSubscriptionEvent event;

    public ExtendSubscriptionEventFE( com.github.twitch4j.chat.events.channel.ExtendSubscriptionEvent event )
    {
        this.event = event;
    }

    public boolean equals( java.lang.Object arg0 ) // Declaring Class: com.github.twitch4j.chat.events.channel.ExtendSubscriptionEvent
    {
        return this.event.equals( arg0 );

    }
    public java.lang.String toString( ) // Declaring Class: com.github.twitch4j.chat.events.channel.ExtendSubscriptionEvent
    {
        return this.event.toString(  );

    }
    public int hashCode( ) // Declaring Class: com.github.twitch4j.chat.events.channel.ExtendSubscriptionEvent
    {
        return this.event.hashCode(  );

    }
    public int getCumulativeMonths( ) // Declaring Class: com.github.twitch4j.chat.events.channel.ExtendSubscriptionEvent
    {
        return this.event.getCumulativeMonths(  );

    }
    public java.time.Month getBenefitEndMonth( ) // Declaring Class: com.github.twitch4j.chat.events.channel.ExtendSubscriptionEvent
    {
        return this.event.getBenefitEndMonth(  );

    }
    public com.github.twitch4j.common.enums.SubscriptionPlan getSubPlan( ) // Declaring Class: com.github.twitch4j.chat.events.channel.ExtendSubscriptionEvent
    {
        return this.event.getSubPlan(  );

    }
    public com.github.twitch4j.common.events.domain.EventUser getUser( ) // Declaring Class: com.github.twitch4j.chat.events.channel.ExtendSubscriptionEvent
    {
