...
public class RewardGiftEventFE extends net.minecraftforge.eventbus.api.Event {
    private final com.github.twitch4j.chat.events.channel.RewardGiftEvent event;

    public RewardGiftEventFE( com.github.twitch4j.chat.events.channel.RewardGiftEvent event )
    {
        this.event = event;
    }

    public boolean equals( java.lang.Object arg0 ) // Declaring Class: com.github.twitch4j.chat.events.channel.RewardGiftEvent
    {
        return this.event.equals( arg0 );

    }
    public java.lang.String toString( ) // Declaring Class: com.github.twitch4j.chat.events.channel.RewardGiftEvent
    {
        return this.event.toString(  );

    }
    public int hashCode( ) // Declaring Class: com.github.twitch4j.chat.events.channel.RewardGiftEvent
    {
        return this.event.hashCode(  );

    }
    public java.lang.Integer getTotalRewardCount( ) // Declaring Class: com.github.twitch4j.chat.events.channel.RewardGiftEvent
    {
        return this.event.getTotalRewardCount(  );

    }
    public java.lang.String getDomain( ) // Declaring Class: com.github.twitch4j.chat.events.channel.RewardGiftEvent
    {
        return this.event.getDomain(  );

    }
    public java.lang.String getTriggerType( ) // Declaring Class: com.github.twitch4j.chat.events.channel.RewardGiftEvent
    {
        return this.event.getTriggerType(  );

    }
    public java.lang.Integer getTriggerAmount( ) // Declaring Class: com.github.twitch4j.chat.events.channel.RewardGiftEvent
    {
        return this.event.getTriggerAmount(  );

    }
    public java.lang.Integer getSelectedCount( ) // Declaring Class: com.github.twitch4j.chat.events.channel.RewardGiftEvent
    {
        return this.event.getSelectedCount(  );

    }
    public com.github.twitch4j.common.events.domain.EventUser getUser( ) // Declaring Class: com.github.twitch4j.chat.events.channel.RewardGiftEvent
    {
