...
public class ChannelStateEventFE extends net.minecraftforge.eventbus.api.Event {
    private final com.github.twitch4j.chat.events.channel.ChannelStateEvent event;

    public ChannelStateEventFE( com.github.twitch4j.chat.events.channel.ChannelStateEvent event )
    {
        this.event = event;
    }

    public boolean equals( java.lang.Object arg0 ) // Declaring Class: com.github.twitch4j.chat.events.channel.ChannelStateEvent
    {
        return this.event.equals( arg0 );

    }
    public java.lang.String toString( ) // Declaring Class: com.github.twitch4j.chat.events.channel.ChannelStateEvent
    {
        return this.event.toString(  );

    }
    public int hashCode( ) // Declaring Class: com.github.twitch4j.chat.events.channel.ChannelStateEvent
    {
        return this.event.hashCode(  );

    }
    public java.lang.Object getState( com.github.twitch4j.chat.events.channel.ChannelStateEvent.ChannelState arg0 ) // Declaring Class: com.github.twitch4j.chat.events.channel.ChannelStateEvent
    {
        return this.event.getState( arg0 );

    }
    public java.util.Map getStates( ) // Declaring Class: com.github.twitch4j.chat.events.channel.ChannelStateEvent
    {
