...
public class ModuleEnabledEventFE extends net.minecraftforge.eventbus.api.Event {
    private final com.github.twitch4j.modules.event.ModuleEnabledEvent event;

    public ModuleEnabledEventFE( com.github.twitch4j.modules.event.ModuleEnabledEvent event )
    {
        this.event = event;
    }
