...
public class ChannelChangeTitleEventFE extends net.minecraftforge.eventbus.api.Event {
    private final com.github.twitch4j.events.ChannelChangeTitleEvent event;

    public ChannelChangeTitleEventFE( com.github.twitch4j.events.ChannelChangeTitleEvent event )
    {
        this.event = event;
    }

    public boolean equals( java.lang.Object arg0 ) // Declaring Class: com.github.twitch4j.events.ChannelChangeTitleEvent
    {
        return this.event.equals( arg0 );

    }
    public java.lang.String toString( ) // Declaring Class: com.github.twitch4j.events.ChannelChangeTitleEvent
    {
        return this.event.toString(  );

    }
    public int hashCode( ) // Declaring Class: com.github.twitch4j.events.ChannelChangeTitleEvent
    {
        return this.event.hashCode(  );

    }
    public com.github.twitch4j.common.events.domain.EventChannel getChannel( ) // Declaring Class: com.github.twitch4j.events.ChannelChangeTitleEvent
    {
        return this.event.getChannel(  );

    }
    public com.github.twitch4j.helix.domain.Stream getStream( ) // Declaring Class: com.github.twitch4j.events.ChannelChangeTitleEvent
    {
        return this.event.getStream(  );

    }
    public java.lang.String getTitle( ) // Declaring Class: com.github.twitch4j.events.ChannelChangeTitleEvent
    {
