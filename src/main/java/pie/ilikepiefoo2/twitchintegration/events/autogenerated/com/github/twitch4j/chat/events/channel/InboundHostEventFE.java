...
public class InboundHostEventFE extends net.minecraftforge.eventbus.api.Event {
    public final com.github.twitch4j.chat.events.channel.InboundHostEvent event;

    public InboundHostEventFE( com.github.twitch4j.chat.events.channel.InboundHostEvent event )
    {
        this.event = event;
    }

    public boolean equals( java.lang.Object arg0 ) // Declaring Class: com.github.twitch4j.chat.events.channel.InboundHostEvent
    {
        return this.event.equals( arg0 );
    }
    public java.lang.String toString( ) // Declaring Class: com.github.twitch4j.chat.events.channel.InboundHostEvent
    {
        return this.event.toString(  );
    }
    public int hashCode( ) // Declaring Class: com.github.twitch4j.chat.events.channel.InboundHostEvent
    {
        return this.event.hashCode(  );
    }
    public java.lang.String getHostTarget( ) // Declaring Class: com.github.twitch4j.chat.events.channel.InboundHostEvent
    {
        return this.event.getHostTarget(  );
    }
    public java.lang.String getHosterName( ) // Declaring Class: com.github.twitch4j.chat.events.channel.InboundHostEvent
    {
        return this.event.getHosterName(  );
    }
