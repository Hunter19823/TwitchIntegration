...
public class PubSubConnectionStateEventFE extends net.minecraftforge.eventbus.api.Event {
    public final com.github.twitch4j.pubsub.events.PubSubConnectionStateEvent event;

    public PubSubConnectionStateEventFE( com.github.twitch4j.pubsub.events.PubSubConnectionStateEvent event )
    {
        this.event = event;
    }

    public boolean equals( java.lang.Object arg0 ) // Declaring Class: com.github.twitch4j.pubsub.events.PubSubConnectionStateEvent
    {
        return this.event.equals( arg0 );
    }
    public com.github.twitch4j.pubsub.TwitchPubSub getConnection( ) // Declaring Class: com.github.twitch4j.pubsub.events.PubSubConnectionStateEvent
    {
    ...
    public com.github.twitch4j.client.websocket.domain.WebsocketConnectionState getPreviousState( ) // Declaring Class: com.github.twitch4j.pubsub.events.PubSubConnectionStateEvent
    {
    ...
    public com.github.twitch4j.client.websocket.domain.WebsocketConnectionState getState( ) // Declaring Class: com.github.twitch4j.pubsub.events.PubSubConnectionStateEvent
    {
        return this.event.getState(  );
    }
    public int hashCode( ) // Declaring Class: com.github.twitch4j.pubsub.events.PubSubConnectionStateEvent
    {
    ...
    public java.lang.String toString( ) // Declaring Class: com.github.twitch4j.pubsub.events.PubSubConnectionStateEvent
    {
