package pie.ilikepiefoo2.twitchintegration.events.autogenerated.com.github.twitch4j.common.events.user;


public class PrivateMessageEventFE extends net.minecraftforge.eventbus.api.Event {
    private final com.github.twitch4j.common.events.user.PrivateMessageEvent event;

    public PrivateMessageEventFE( com.github.twitch4j.common.events.user.PrivateMessageEvent event )
    {
        this.event = event;
    }

    public boolean equals( java.lang.Object arg0 ) // Declaring Class: com.github.twitch4j.common.events.user.PrivateMessageEvent
    {
    ...
    public java.util.Set getPermissions( ) // Declaring Class: com.github.twitch4j.common.events.user.PrivateMessageEvent
    {
