...
public class RewardRedeemedEventFE extends net.minecraftforge.eventbus.api.Event {
    private final com.github.twitch4j.pubsub.events.RewardRedeemedEvent event;

    public RewardRedeemedEventFE( com.github.twitch4j.pubsub.events.RewardRedeemedEvent event )
    {
        this.event = event;
    }

    public boolean equals( java.lang.Object arg0 ) // Declaring Class: com.github.twitch4j.pubsub.events.RewardRedeemedEvent
    {
