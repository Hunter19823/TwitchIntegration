...
public class UserModerationActionEventFE extends net.minecraftforge.eventbus.api.Event {
    public final com.github.twitch4j.pubsub.events.UserModerationActionEvent event;

    public UserModerationActionEventFE( com.github.twitch4j.pubsub.events.UserModerationActionEvent event )
    {
        this.event = event;
    }

    public boolean equals( java.lang.Object arg0 ) // Declaring Class: com.github.twitch4j.pubsub.events.UserModerationActionEvent
    {
        return this.event.equals( arg0 );
    }
    public com.github.twitch4j.pubsub.domain.UserModerationActionData getData( ) // Declaring Class: com.github.twitch4j.pubsub.events.UserModerationActionEvent
    {
    ...
    public java.lang.String getUserId( ) // Declaring Class: com.github.twitch4j.pubsub.events.UserModerationActionEvent
    {
        return this.event.getUserId(  );
    }
    public int hashCode( ) // Declaring Class: com.github.twitch4j.pubsub.events.UserModerationActionEvent
    {
    ...
    public java.lang.String toString( ) // Declaring Class: com.github.twitch4j.pubsub.events.UserModerationActionEvent
    {
