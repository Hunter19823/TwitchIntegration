...
public class PrimeSubUpgradeEventFE extends net.minecraftforge.eventbus.api.Event {
    private final com.github.twitch4j.chat.events.channel.PrimeSubUpgradeEvent event;

    public PrimeSubUpgradeEventFE( com.github.twitch4j.chat.events.channel.PrimeSubUpgradeEvent event )
    {
        this.event = event;
    }

    public boolean equals( java.lang.Object arg0 ) // Declaring Class: com.github.twitch4j.chat.events.channel.PrimeSubUpgradeEvent
    {
        return this.event.equals( arg0 );

    }
    public java.lang.String toString( ) // Declaring Class: com.github.twitch4j.chat.events.channel.PrimeSubUpgradeEvent
    {
        return this.event.toString(  );

    }
    public int hashCode( ) // Declaring Class: com.github.twitch4j.chat.events.channel.PrimeSubUpgradeEvent
    {
        return this.event.hashCode(  );

    }
    public com.github.twitch4j.common.enums.SubscriptionPlan getSubscriptionPlan( ) // Declaring Class: com.github.twitch4j.chat.events.channel.PrimeSubUpgradeEvent
    {
        return this.event.getSubscriptionPlan(  );

    }
    public com.github.twitch4j.common.events.domain.EventUser getUser( ) // Declaring Class: com.github.twitch4j.chat.events.channel.PrimeSubUpgradeEvent
    {
