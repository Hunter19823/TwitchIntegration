...
public class CreatorGoalEventFE extends net.minecraftforge.eventbus.api.Event {
    public final com.github.twitch4j.pubsub.events.CreatorGoalEvent event;

    public CreatorGoalEventFE( com.github.twitch4j.pubsub.events.CreatorGoalEvent event )
    {
        this.event = event;
    }

    public boolean equals( java.lang.Object arg0 ) // Declaring Class: com.github.twitch4j.pubsub.events.CreatorGoalEvent
    {
    ...
    {
        return this.event.isGoalAchieve(  );
    }
    public boolean isGoalCreate( ) // Declaring Class: com.github.twitch4j.pubsub.events.CreatorGoalEvent
    {
