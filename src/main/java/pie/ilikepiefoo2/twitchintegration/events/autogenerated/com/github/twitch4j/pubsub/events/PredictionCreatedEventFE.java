...
public class PredictionCreatedEventFE extends net.minecraftforge.eventbus.api.Event {
    private final com.github.twitch4j.pubsub.events.PredictionCreatedEvent event;

    public PredictionCreatedEventFE( com.github.twitch4j.pubsub.events.PredictionCreatedEvent event )
    {
        this.event = event;
    }

    public boolean equals( java.lang.Object arg0 ) // Declaring Class: com.github.twitch4j.pubsub.events.PredictionCreatedEvent
    {
        return this.event.equals( arg0 );

    }
    public java.lang.String toString( ) // Declaring Class: com.github.twitch4j.pubsub.events.PredictionCreatedEvent
    {
        return this.event.toString(  );

    }
    public int hashCode( ) // Declaring Class: com.github.twitch4j.pubsub.events.PredictionCreatedEvent
    {
        return this.event.hashCode(  );

    }
    public java.time.Instant getTimestamp( ) // Declaring Class: com.github.twitch4j.pubsub.events.PredictionCreatedEvent
    {
        return this.event.getTimestamp(  );

    }
    public com.github.twitch4j.pubsub.domain.PredictionEvent getEvent( ) // Declaring Class: com.github.twitch4j.pubsub.events.PredictionCreatedEvent
    {
