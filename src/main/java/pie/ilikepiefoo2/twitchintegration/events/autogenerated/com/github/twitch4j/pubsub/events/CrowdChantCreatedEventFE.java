...
@Deprecated
public class CrowdChantCreatedEventFE extends net.minecraftforge.eventbus.api.Event {
    public final com.github.twitch4j.pubsub.events.CrowdChantCreatedEvent event;

    public CrowdChantCreatedEventFE( com.github.twitch4j.pubsub.events.CrowdChantCreatedEvent event )
    {
        this.event = event;
    }

    public boolean equals( java.lang.Object arg0 ) // Declaring Class: com.github.twitch4j.pubsub.events.CrowdChantCreatedEvent
    {
        return this.event.equals( arg0 );
    }
    public com.github.twitch4j.pubsub.domain.CrowdChant getCrowdChant( ) // Declaring Class: com.github.twitch4j.pubsub.events.CrowdChantCreatedEvent
    {
        return this.event.getCrowdChant(  );
    }
    ...
    public java.time.Instant getTimestamp( ) // Declaring Class: com.github.twitch4j.pubsub.events.CrowdChantCreatedEvent
    {
        return this.event.getTimestamp(  );
    }
    public int hashCode( ) // Declaring Class: com.github.twitch4j.pubsub.events.CrowdChantCreatedEvent
    {
    ...
    public java.lang.String toString( ) // Declaring Class: com.github.twitch4j.pubsub.events.CrowdChantCreatedEvent
    {
