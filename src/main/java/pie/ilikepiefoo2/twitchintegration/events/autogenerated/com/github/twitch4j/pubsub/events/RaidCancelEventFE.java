...
public class RaidCancelEventFE extends net.minecraftforge.eventbus.api.Event {
    private final com.github.twitch4j.pubsub.events.RaidCancelEvent event;

    public RaidCancelEventFE( com.github.twitch4j.pubsub.events.RaidCancelEvent event )
    {
        this.event = event;
    }

    public boolean equals( java.lang.Object arg0 ) // Declaring Class: com.github.twitch4j.pubsub.events.RaidCancelEvent
    {
        return this.event.equals( arg0 );

    }
    public java.lang.String toString( ) // Declaring Class: com.github.twitch4j.pubsub.events.RaidCancelEvent
    {
        return this.event.toString(  );

    }
    public int hashCode( ) // Declaring Class: com.github.twitch4j.pubsub.events.RaidCancelEvent
    {
        return this.event.hashCode(  );

    }
    public com.github.twitch4j.pubsub.domain.RaidData getRaid( ) // Declaring Class: com.github.twitch4j.pubsub.events.RaidCancelEvent
    {
