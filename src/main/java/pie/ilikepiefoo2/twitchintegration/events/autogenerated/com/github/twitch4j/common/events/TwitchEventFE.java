package pie.ilikepiefoo2.twitchintegration.events.autogenerated.com.github.twitch4j.common.events;


public class TwitchEventFE extends net.minecraftforge.eventbus.api.Event {
    private final com.github.twitch4j.common.events.TwitchEvent event;

    public TwitchEventFE( com.github.twitch4j.common.events.TwitchEvent event )
    {
        this.event = event;
    }

    public boolean equals( java.lang.Object arg0 ) // Declaring Class: com.github.twitch4j.common.events.TwitchEvent
    {
        return this.event.equals( arg0 );

    }
    public java.lang.String toString( ) // Declaring Class: com.github.twitch4j.common.events.TwitchEvent
    {
        return this.event.toString(  );

    }
    public int hashCode( ) // Declaring Class: com.github.twitch4j.common.events.TwitchEvent
    {
