...
public class UserPresenceEventFE extends net.minecraftforge.eventbus.api.Event {
    private final com.github.twitch4j.pubsub.events.UserPresenceEvent event;

    public UserPresenceEventFE( com.github.twitch4j.pubsub.events.UserPresenceEvent event )
    {
        this.event = event;
    }

    public boolean equals( java.lang.Object arg0 ) // Declaring Class: com.github.twitch4j.pubsub.events.UserPresenceEvent
    {
        return this.event.equals( arg0 );

    }
    public java.lang.String toString( ) // Declaring Class: com.github.twitch4j.pubsub.events.UserPresenceEvent
    {
        return this.event.toString(  );

    }
    public int hashCode( ) // Declaring Class: com.github.twitch4j.pubsub.events.UserPresenceEvent
    {
        return this.event.hashCode(  );

    }
    public com.github.twitch4j.pubsub.domain.PresenceData getData( ) // Declaring Class: com.github.twitch4j.pubsub.events.UserPresenceEvent
    {
