...
public class ChannelMessageActionEventFE extends net.minecraftforge.eventbus.api.Event {
    private final com.github.twitch4j.chat.events.channel.ChannelMessageActionEvent event;

    public ChannelMessageActionEventFE( com.github.twitch4j.chat.events.channel.ChannelMessageActionEvent event )
    {
        this.event = event;
    }

    public boolean equals( java.lang.Object arg0 ) // Declaring Class: com.github.twitch4j.chat.events.channel.ChannelMessageActionEvent
    {
        return this.event.equals( arg0 );

    }
    public java.lang.String toString( ) // Declaring Class: com.github.twitch4j.chat.events.channel.ChannelMessageActionEvent
    {
        return this.event.toString(  );

    }
    public int hashCode( ) // Declaring Class: com.github.twitch4j.chat.events.channel.ChannelMessageActionEvent
    {
        return this.event.hashCode(  );

    }
    public java.lang.String getMessage( ) // Declaring Class: com.github.twitch4j.chat.events.channel.ChannelMessageActionEvent
    {
        return this.event.getMessage(  );

    }
    public java.util.Set getPermissions( ) // Declaring Class: com.github.twitch4j.chat.events.channel.ChannelMessageActionEvent
    {
        return this.event.getPermissions(  );

    }
    public java.util.List getFlags( ) // Declaring Class: com.github.twitch4j.chat.events.channel.ChannelMessageActionEvent
    {
