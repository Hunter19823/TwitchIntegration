...
public class ListVipsEventFE extends net.minecraftforge.eventbus.api.Event {
    private final com.github.twitch4j.chat.events.channel.ListVipsEvent event;

    public ListVipsEventFE( com.github.twitch4j.chat.events.channel.ListVipsEvent event )
    {
        this.event = event;
    }

    public boolean equals( java.lang.Object arg0 ) // Declaring Class: com.github.twitch4j.chat.events.channel.ListVipsEvent
    {
        return this.event.equals( arg0 );

    }
    public java.lang.String toString( ) // Declaring Class: com.github.twitch4j.chat.events.channel.ListVipsEvent
    {
        return this.event.toString(  );

    }
    public int hashCode( ) // Declaring Class: com.github.twitch4j.chat.events.channel.ListVipsEvent
    {
        return this.event.hashCode(  );

    }
    public java.util.List getVips( ) // Declaring Class: com.github.twitch4j.chat.events.channel.ListVipsEvent
    {
