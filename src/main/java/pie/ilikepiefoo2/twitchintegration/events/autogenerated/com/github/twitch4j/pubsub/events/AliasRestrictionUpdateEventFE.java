...
public class AliasRestrictionUpdateEventFE extends net.minecraftforge.eventbus.api.Event {
    public final com.github.twitch4j.pubsub.events.AliasRestrictionUpdateEvent event;

    public AliasRestrictionUpdateEventFE( com.github.twitch4j.pubsub.events.AliasRestrictionUpdateEvent event )
    {
        this.event = event;
    }

    public boolean equals( java.lang.Object arg0 ) // Declaring Class: com.github.twitch4j.pubsub.events.AliasRestrictionUpdateEvent
    {
        return this.event.equals( arg0 );
    }
    public com.github.twitch4j.pubsub.domain.AliasRestrictionUpdateData getData( ) // Declaring Class: com.github.twitch4j.pubsub.events.AliasRestrictionUpdateEvent
    {
    ...
    public java.lang.String getUserId( ) // Declaring Class: com.github.twitch4j.pubsub.events.AliasRestrictionUpdateEvent
    {
        return this.event.getUserId(  );
    }
    public int hashCode( ) // Declaring Class: com.github.twitch4j.pubsub.events.AliasRestrictionUpdateEvent
    {
    ...
    public java.lang.String toString( ) // Declaring Class: com.github.twitch4j.pubsub.events.AliasRestrictionUpdateEvent
    {
