...
public class ListModsEventFE extends net.minecraftforge.eventbus.api.Event {
    private final com.github.twitch4j.chat.events.channel.ListModsEvent event;

    public ListModsEventFE( com.github.twitch4j.chat.events.channel.ListModsEvent event )
    {
        this.event = event;
    }

    public boolean equals( java.lang.Object arg0 ) // Declaring Class: com.github.twitch4j.chat.events.channel.ListModsEvent
    {
        return this.event.equals( arg0 );

    }
    public java.lang.String toString( ) // Declaring Class: com.github.twitch4j.chat.events.channel.ListModsEvent
    {
        return this.event.toString(  );

    }
    public int hashCode( ) // Declaring Class: com.github.twitch4j.chat.events.channel.ListModsEvent
    {
        return this.event.hashCode(  );

    }
    public java.util.List getModerators( ) // Declaring Class: com.github.twitch4j.chat.events.channel.ListModsEvent
    {
