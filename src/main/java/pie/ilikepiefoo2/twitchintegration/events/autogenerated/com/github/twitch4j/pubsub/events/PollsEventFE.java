...
public class PollsEventFE extends net.minecraftforge.eventbus.api.Event {
    private final com.github.twitch4j.pubsub.events.PollsEvent event;

    public PollsEventFE( com.github.twitch4j.pubsub.events.PollsEvent event )
    {
        this.event = event;
    }

    public boolean equals( java.lang.Object arg0 ) // Declaring Class: com.github.twitch4j.pubsub.events.PollsEvent
    {
        return this.event.equals( arg0 );

    }
    public java.lang.String toString( ) // Declaring Class: com.github.twitch4j.pubsub.events.PollsEvent
    {
        return this.event.toString(  );

    }
    public int hashCode( ) // Declaring Class: com.github.twitch4j.pubsub.events.PollsEvent
    {
        return this.event.hashCode(  );

    }
    public com.github.twitch4j.pubsub.events.PollsEvent.EventType getType( ) // Declaring Class: com.github.twitch4j.pubsub.events.PollsEvent
    {
        return this.event.getType(  );

    }
    public com.github.twitch4j.pubsub.domain.PollData getData( ) // Declaring Class: com.github.twitch4j.pubsub.events.PollsEvent
    {
