...
public class ChannelGoOfflineEventFE extends net.minecraftforge.eventbus.api.Event {
    private final com.github.twitch4j.common.events.channel.ChannelGoOfflineEvent event;

    public ChannelGoOfflineEventFE( com.github.twitch4j.common.events.channel.ChannelGoOfflineEvent event )
    {
        this.event = event;
    }

    public boolean equals( java.lang.Object arg0 ) // Declaring Class: com.github.twitch4j.common.events.channel.ChannelGoOfflineEvent
    {
        return this.event.equals( arg0 );

    }
    public java.lang.String toString( ) // Declaring Class: com.github.twitch4j.common.events.channel.ChannelGoOfflineEvent
    {
        return this.event.toString(  );

    }
    public int hashCode( ) // Declaring Class: com.github.twitch4j.common.events.channel.ChannelGoOfflineEvent
    {
        return this.event.hashCode(  );

    }
    public com.github.twitch4j.common.events.domain.EventChannel getChannel( ) // Declaring Class: com.github.twitch4j.common.events.channel.ChannelGoOfflineEvent
    {
