...
public class SupportActivityFeedEventFE extends net.minecraftforge.eventbus.api.Event {
    public final com.github.twitch4j.pubsub.events.SupportActivityFeedEvent event;

    public SupportActivityFeedEventFE( com.github.twitch4j.pubsub.events.SupportActivityFeedEvent event )
    {
        this.event = event;
    }

    public boolean equals( java.lang.Object arg0 ) // Declaring Class: com.github.twitch4j.pubsub.events.SupportActivityFeedEvent
    {
        return this.event.equals( arg0 );
    }
    public java.lang.String getChannelId( ) // Declaring Class: com.github.twitch4j.pubsub.events.SupportActivityFeedEvent
    {
        return this.event.getChannelId(  );
    }
    public com.github.twitch4j.pubsub.domain.SupportActivityFeedData getData( ) // Declaring Class: com.github.twitch4j.pubsub.events.SupportActivityFeedEvent
    {
    ...
    public int hashCode( ) // Declaring Class: com.github.twitch4j.pubsub.events.SupportActivityFeedEvent
    {
    ...
    public java.lang.String toString( ) // Declaring Class: com.github.twitch4j.pubsub.events.SupportActivityFeedEvent
    {
