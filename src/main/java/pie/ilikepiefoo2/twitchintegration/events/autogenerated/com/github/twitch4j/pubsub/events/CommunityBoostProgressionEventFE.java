...
public class CommunityBoostProgressionEventFE extends net.minecraftforge.eventbus.api.Event {
    public final com.github.twitch4j.pubsub.events.CommunityBoostProgressionEvent event;

    public CommunityBoostProgressionEventFE( com.github.twitch4j.pubsub.events.CommunityBoostProgressionEvent event )
    {
        this.event = event;
    }

    public boolean equals( java.lang.Object arg0 ) // Declaring Class: com.github.twitch4j.pubsub.events.CommunityBoostProgressionEvent
    {
        return this.event.equals( arg0 );
    }
    public com.github.twitch4j.pubsub.domain.CommunityBoostProgression getData( ) // Declaring Class: com.github.twitch4j.pubsub.events.CommunityBoostProgressionEvent
    {
    ...
    public int hashCode( ) // Declaring Class: com.github.twitch4j.pubsub.events.CommunityBoostProgressionEvent
    {
    ...
    public java.lang.String toString( ) // Declaring Class: com.github.twitch4j.pubsub.events.CommunityBoostProgressionEvent
    {
