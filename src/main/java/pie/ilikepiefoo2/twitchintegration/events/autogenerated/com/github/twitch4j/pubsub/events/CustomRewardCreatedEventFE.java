...
public class CustomRewardCreatedEventFE extends net.minecraftforge.eventbus.api.Event {
    private final com.github.twitch4j.pubsub.events.CustomRewardCreatedEvent event;

    public CustomRewardCreatedEventFE( com.github.twitch4j.pubsub.events.CustomRewardCreatedEvent event )
    {
        this.event = event;
    }

    public boolean equals( java.lang.Object arg0 ) // Declaring Class: com.github.twitch4j.pubsub.events.CustomRewardCreatedEvent
    {
        return this.event.equals( arg0 );

    }
    public java.lang.String toString( ) // Declaring Class: com.github.twitch4j.pubsub.events.CustomRewardCreatedEvent
    {
        return this.event.toString(  );

    }
    public int hashCode( ) // Declaring Class: com.github.twitch4j.pubsub.events.CustomRewardCreatedEvent
    {
        return this.event.hashCode(  );

    }
    public java.time.Instant getTimestamp( ) // Declaring Class: com.github.twitch4j.pubsub.events.CustomRewardEvent
    {
        return this.event.getTimestamp(  );

    }
    public com.github.twitch4j.pubsub.domain.ChannelPointsReward getReward( ) // Declaring Class: com.github.twitch4j.pubsub.events.CustomRewardEvent
    {
