...
public class AutomodLevelsModifiedEventFE extends net.minecraftforge.eventbus.api.Event {
    public final com.github.twitch4j.pubsub.events.AutomodLevelsModifiedEvent event;

    public AutomodLevelsModifiedEventFE( com.github.twitch4j.pubsub.events.AutomodLevelsModifiedEvent event )
    {
        this.event = event;
    }

    public boolean equals( java.lang.Object arg0 ) // Declaring Class: com.github.twitch4j.pubsub.events.AutomodLevelsModifiedEvent
    {
        return this.event.equals( arg0 );
    }
    public java.lang.String toString( ) // Declaring Class: com.github.twitch4j.pubsub.events.AutomodLevelsModifiedEvent
    {
        return this.event.toString(  );
    }
    public int hashCode( ) // Declaring Class: com.github.twitch4j.pubsub.events.AutomodLevelsModifiedEvent
    {
        return this.event.hashCode(  );
    }
    public com.github.twitch4j.pubsub.domain.AutomodLevelsModified getData( ) // Declaring Class: com.github.twitch4j.pubsub.events.AutomodLevelsModifiedEvent
    {
        return this.event.getData(  );
    }
    public java.lang.String getChannelId( ) // Declaring Class: com.github.twitch4j.pubsub.events.AutomodLevelsModifiedEvent
    {
