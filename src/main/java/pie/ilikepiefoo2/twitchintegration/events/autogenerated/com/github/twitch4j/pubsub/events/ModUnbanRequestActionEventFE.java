...
public class ModUnbanRequestActionEventFE extends net.minecraftforge.eventbus.api.Event {
    public final com.github.twitch4j.pubsub.events.ModUnbanRequestActionEvent event;

    public ModUnbanRequestActionEventFE( com.github.twitch4j.pubsub.events.ModUnbanRequestActionEvent event )
    {
        this.event = event;
    }

    public boolean equals( java.lang.Object arg0 ) // Declaring Class: com.github.twitch4j.pubsub.events.ModUnbanRequestActionEvent
    {
        return this.event.equals( arg0 );
    }
    public java.lang.String getChannelId( ) // Declaring Class: com.github.twitch4j.pubsub.events.ModUnbanRequestActionEvent
    {
        return this.event.getChannelId(  );
    }
    public com.github.twitch4j.pubsub.domain.ModeratorUnbanRequestAction getData( ) // Declaring Class: com.github.twitch4j.pubsub.events.ModUnbanRequestActionEvent
    {
    ...
    public int hashCode( ) // Declaring Class: com.github.twitch4j.pubsub.events.ModUnbanRequestActionEvent
    {
    ...
    public java.lang.String toString( ) // Declaring Class: com.github.twitch4j.pubsub.events.ModUnbanRequestActionEvent
    {
