...
public class GiftSubUpgradeEventFE extends net.minecraftforge.eventbus.api.Event {
    private final com.github.twitch4j.chat.events.channel.GiftSubUpgradeEvent event;

    public GiftSubUpgradeEventFE( com.github.twitch4j.chat.events.channel.GiftSubUpgradeEvent event )
    {
        this.event = event;
    }

    public boolean equals( java.lang.Object arg0 ) // Declaring Class: com.github.twitch4j.chat.events.channel.GiftSubUpgradeEvent
    {
        return this.event.equals( arg0 );

    }
    public java.lang.String toString( ) // Declaring Class: com.github.twitch4j.chat.events.channel.GiftSubUpgradeEvent
    {
        return this.event.toString(  );

    }
    public int hashCode( ) // Declaring Class: com.github.twitch4j.chat.events.channel.GiftSubUpgradeEvent
    {
        return this.event.hashCode(  );

    }
    public com.github.twitch4j.common.events.domain.EventUser getUpgradingUser( ) // Declaring Class: com.github.twitch4j.chat.events.channel.GiftSubUpgradeEvent
    {
        return this.event.getUpgradingUser(  );

    }
    public java.lang.String getPromoName( ) // Declaring Class: com.github.twitch4j.chat.events.channel.GiftSubUpgradeEvent
    {
        return this.event.getPromoName(  );

    }
    public java.lang.Integer getPromoGiftTotal( ) // Declaring Class: com.github.twitch4j.chat.events.channel.GiftSubUpgradeEvent
    {
        return this.event.getPromoGiftTotal(  );

    }
    public java.lang.String getGifterLogin( ) // Declaring Class: com.github.twitch4j.chat.events.channel.GiftSubUpgradeEvent
    {
        return this.event.getGifterLogin(  );

    }
    public java.lang.String getGifterName( ) // Declaring Class: com.github.twitch4j.chat.events.channel.GiftSubUpgradeEvent
    {
