...
public class IRCMessageEventFE extends net.minecraftforge.eventbus.api.Event {
    ...
    public java.util.OptionalInt getPredictedChoiceIndex( ) // Declaring Class: com.github.twitch4j.chat.events.channel.IRCMessageEvent
    {
        return this.event.getPredictedChoiceIndex(  );
    }
    public java.util.Optional getPredictedChoiceTitle( ) // Declaring Class: com.github.twitch4j.chat.events.channel.IRCMessageEvent
    {
        return this.event.getPredictedChoiceTitle(  );
    }
