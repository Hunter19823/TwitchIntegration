...
public class LowTrustUserTreatmentUpdateEventFE extends net.minecraftforge.eventbus.api.Event {
    public final com.github.twitch4j.pubsub.events.LowTrustUserTreatmentUpdateEvent event;

    public LowTrustUserTreatmentUpdateEventFE( com.github.twitch4j.pubsub.events.LowTrustUserTreatmentUpdateEvent event )
    {
        this.event = event;
    }

    public boolean equals( java.lang.Object arg0 ) // Declaring Class: com.github.twitch4j.pubsub.events.LowTrustUserTreatmentUpdateEvent
    {
        return this.event.equals( arg0 );
    }
    public java.lang.String getChannelId( ) // Declaring Class: com.github.twitch4j.pubsub.events.LowTrustUserTreatmentUpdateEvent
    {
        return this.event.getChannelId(  );
    }
    public com.github.twitch4j.pubsub.domain.LowTrustUserTreatmentUpdate getData( ) // Declaring Class: com.github.twitch4j.pubsub.events.LowTrustUserTreatmentUpdateEvent
    {
    ...
    public java.lang.String getModeratorId( ) // Declaring Class: com.github.twitch4j.pubsub.events.LowTrustUserTreatmentUpdateEvent
    {
        return this.event.getModeratorId(  );
    }
    ...
    public int hashCode( ) // Declaring Class: com.github.twitch4j.pubsub.events.LowTrustUserTreatmentUpdateEvent
    {
    ...
    public java.lang.String toString( ) // Declaring Class: com.github.twitch4j.pubsub.events.LowTrustUserTreatmentUpdateEvent
    {
