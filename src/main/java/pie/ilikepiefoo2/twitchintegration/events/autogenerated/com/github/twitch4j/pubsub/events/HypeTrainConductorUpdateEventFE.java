...
public class HypeTrainConductorUpdateEventFE extends net.minecraftforge.eventbus.api.Event {
    private final com.github.twitch4j.pubsub.events.HypeTrainConductorUpdateEvent event;

    public HypeTrainConductorUpdateEventFE( com.github.twitch4j.pubsub.events.HypeTrainConductorUpdateEvent event )
    {
        this.event = event;
    }

    public boolean equals( java.lang.Object arg0 ) // Declaring Class: com.github.twitch4j.pubsub.events.HypeTrainConductorUpdateEvent
    {
        return this.event.equals( arg0 );

    }
    public java.lang.String toString( ) // Declaring Class: com.github.twitch4j.pubsub.events.HypeTrainConductorUpdateEvent
    {
        return this.event.toString(  );

    }
    public int hashCode( ) // Declaring Class: com.github.twitch4j.pubsub.events.HypeTrainConductorUpdateEvent
    {
        return this.event.hashCode(  );

    }
    public com.github.twitch4j.pubsub.domain.HypeTrainConductor getData( ) // Declaring Class: com.github.twitch4j.pubsub.events.HypeTrainConductorUpdateEvent
    {
        return this.event.getData(  );

    }
    public java.lang.String getChannelId( ) // Declaring Class: com.github.twitch4j.pubsub.events.HypeTrainConductorUpdateEvent
    {
