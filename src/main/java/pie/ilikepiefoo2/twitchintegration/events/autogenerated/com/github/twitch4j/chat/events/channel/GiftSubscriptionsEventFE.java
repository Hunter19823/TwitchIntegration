...
public class GiftSubscriptionsEventFE extends net.minecraftforge.eventbus.api.Event {
    private final com.github.twitch4j.chat.events.channel.GiftSubscriptionsEvent event;

    public GiftSubscriptionsEventFE( com.github.twitch4j.chat.events.channel.GiftSubscriptionsEvent event )
    {
        this.event = event;
    }

    public boolean equals( java.lang.Object arg0 ) // Declaring Class: com.github.twitch4j.chat.events.channel.GiftSubscriptionsEvent
    {
        return this.event.equals( arg0 );

    }
    public java.lang.String toString( ) // Declaring Class: com.github.twitch4j.chat.events.channel.GiftSubscriptionsEvent
    {
        return this.event.toString(  );

    }
    public int hashCode( ) // Declaring Class: com.github.twitch4j.chat.events.channel.GiftSubscriptionsEvent
    {
        return this.event.hashCode(  );

    }
    public java.lang.Integer getCount( ) // Declaring Class: com.github.twitch4j.chat.events.channel.GiftSubscriptionsEvent
    {
        return this.event.getCount(  );

    }
    public java.lang.String getSubscriptionPlan( ) // Declaring Class: com.github.twitch4j.chat.events.channel.GiftSubscriptionsEvent
    {
        return this.event.getSubscriptionPlan(  );

    }
    public java.lang.Integer getTotalCount( ) // Declaring Class: com.github.twitch4j.chat.events.channel.GiftSubscriptionsEvent
    {
        return this.event.getTotalCount(  );

    }
    public com.github.twitch4j.common.events.domain.EventUser getUser( ) // Declaring Class: com.github.twitch4j.chat.events.channel.GiftSubscriptionsEvent
    {
