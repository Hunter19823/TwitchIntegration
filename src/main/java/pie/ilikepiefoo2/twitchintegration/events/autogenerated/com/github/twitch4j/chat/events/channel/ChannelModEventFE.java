...
public class ChannelModEventFE extends net.minecraftforge.eventbus.api.Event {
    private final com.github.twitch4j.chat.events.channel.ChannelModEvent event;

    public ChannelModEventFE( com.github.twitch4j.chat.events.channel.ChannelModEvent event )
    {
        this.event = event;
    }

    public boolean equals( java.lang.Object arg0 ) // Declaring Class: com.github.twitch4j.chat.events.channel.ChannelModEvent
    {
        return this.event.equals( arg0 );

    }
    public java.lang.String toString( ) // Declaring Class: com.github.twitch4j.chat.events.channel.ChannelModEvent
    {
        return this.event.toString(  );

    }
    public int hashCode( ) // Declaring Class: com.github.twitch4j.chat.events.channel.ChannelModEvent
    {
        return this.event.hashCode(  );

    }
    public boolean isMod( ) // Declaring Class: com.github.twitch4j.chat.events.channel.ChannelModEvent
    {
        return this.event.isMod(  );

    }
    public com.github.twitch4j.common.events.domain.EventUser getUser( ) // Declaring Class: com.github.twitch4j.chat.events.channel.ChannelModEvent
    {
