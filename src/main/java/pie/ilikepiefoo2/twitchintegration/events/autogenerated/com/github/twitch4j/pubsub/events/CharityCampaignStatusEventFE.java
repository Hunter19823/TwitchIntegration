...
public class CharityCampaignStatusEventFE extends net.minecraftforge.eventbus.api.Event {
    public final com.github.twitch4j.pubsub.events.CharityCampaignStatusEvent event;

    public CharityCampaignStatusEventFE( com.github.twitch4j.pubsub.events.CharityCampaignStatusEvent event )
    {
        this.event = event;
    }

    public boolean equals( java.lang.Object arg0 ) // Declaring Class: com.github.twitch4j.pubsub.events.CharityCampaignStatusEvent
    {
        return this.event.equals( arg0 );
    }
    public java.lang.String getChannelId( ) // Declaring Class: com.github.twitch4j.pubsub.events.CharityCampaignStatusEvent
    {
        return this.event.getChannelId(  );
    }
    public com.github.twitch4j.pubsub.domain.CharityCampaignStatus getData( ) // Declaring Class: com.github.twitch4j.pubsub.events.CharityCampaignStatusEvent
    {
    ...
    public int hashCode( ) // Declaring Class: com.github.twitch4j.pubsub.events.CharityCampaignStatusEvent
    {
    ...
    public java.lang.String toString( ) // Declaring Class: com.github.twitch4j.pubsub.events.CharityCampaignStatusEvent
    {
