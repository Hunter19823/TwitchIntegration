...
public class UpdateRedemptionProgressEventFE extends net.minecraftforge.eventbus.api.Event {
    private final com.github.twitch4j.pubsub.events.UpdateRedemptionProgressEvent event;

    public UpdateRedemptionProgressEventFE( com.github.twitch4j.pubsub.events.UpdateRedemptionProgressEvent event )
    {
        this.event = event;
    }

    public boolean equals( java.lang.Object arg0 ) // Declaring Class: com.github.twitch4j.pubsub.events.UpdateRedemptionProgressEvent
    {
        return this.event.equals( arg0 );

    }
    public java.lang.String toString( ) // Declaring Class: com.github.twitch4j.pubsub.events.UpdateRedemptionProgressEvent
    {
        return this.event.toString(  );

    }
    public int hashCode( ) // Declaring Class: com.github.twitch4j.pubsub.events.UpdateRedemptionProgressEvent
    {
