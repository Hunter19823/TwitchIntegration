...
public class SubscribersOnlyEventFE extends net.minecraftforge.eventbus.api.Event {
    private final com.github.twitch4j.chat.events.roomstate.SubscribersOnlyEvent event;

    public SubscribersOnlyEventFE( com.github.twitch4j.chat.events.roomstate.SubscribersOnlyEvent event )
    {
        this.event = event;
    }
