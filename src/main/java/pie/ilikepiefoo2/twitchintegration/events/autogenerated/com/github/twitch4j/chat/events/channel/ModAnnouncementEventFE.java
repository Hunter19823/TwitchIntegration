...
public class ModAnnouncementEventFE extends net.minecraftforge.eventbus.api.Event {
    public final com.github.twitch4j.chat.events.channel.ModAnnouncementEvent event;

    public ModAnnouncementEventFE( com.github.twitch4j.chat.events.channel.ModAnnouncementEvent event )
    {
        this.event = event;
    }
    ...
    public boolean equals( java.lang.Object arg0 ) // Declaring Class: com.github.twitch4j.chat.events.channel.ModAnnouncementEvent
    {
        return this.event.equals( arg0 );
    }
    public com.github.twitch4j.common.events.domain.EventUser getAnnouncer( ) // Declaring Class: com.github.twitch4j.chat.events.channel.ModAnnouncementEvent
    {
        return this.event.getAnnouncer(  );
    }
    ...
    public com.github.twitch4j.chat.enums.AnnouncementColor getColor( ) // Declaring Class: com.github.twitch4j.chat.events.channel.ModAnnouncementEvent
    {
    ...
    public java.lang.String getMessage( ) // Declaring Class: com.github.twitch4j.chat.events.channel.ModAnnouncementEvent
    {
        return this.event.getMessage(  );
    }
    public com.github.twitch4j.chat.events.channel.IRCMessageEvent getMessageEvent( ) // Declaring Class: com.github.twitch4j.chat.events.channel.ModAnnouncementEvent
    {
    ...
    public int hashCode( ) // Declaring Class: com.github.twitch4j.chat.events.channel.ModAnnouncementEvent
    {
    ...
    public java.lang.String toString( ) // Declaring Class: com.github.twitch4j.chat.events.channel.ModAnnouncementEvent
    {
