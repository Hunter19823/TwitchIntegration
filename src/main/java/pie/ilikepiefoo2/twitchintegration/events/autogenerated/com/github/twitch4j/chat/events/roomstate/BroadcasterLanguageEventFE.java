...
public class BroadcasterLanguageEventFE extends net.minecraftforge.eventbus.api.Event {
    private final com.github.twitch4j.chat.events.roomstate.BroadcasterLanguageEvent event;

    public BroadcasterLanguageEventFE( com.github.twitch4j.chat.events.roomstate.BroadcasterLanguageEvent event )
    {
        this.event = event;
    }

    public boolean equals( java.lang.Object arg0 ) // Declaring Class: com.github.twitch4j.chat.events.roomstate.BroadcasterLanguageEvent
    {
        return this.event.equals( arg0 );

    }
    public java.lang.String toString( ) // Declaring Class: com.github.twitch4j.chat.events.roomstate.BroadcasterLanguageEvent
    {
        return this.event.toString(  );

    }
    public int hashCode( ) // Declaring Class: com.github.twitch4j.chat.events.roomstate.BroadcasterLanguageEvent
    {
        return this.event.hashCode(  );

    }
    public java.util.Locale getLanguage( ) // Declaring Class: com.github.twitch4j.chat.events.roomstate.BroadcasterLanguageEvent
    {
